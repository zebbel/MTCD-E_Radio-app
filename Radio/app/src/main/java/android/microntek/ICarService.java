...
public interface ICarService extends IInterface {
    ...
    abstract class Stub extends Binder implements ICarService {
        ...
        static final int TRANSACTION_putByteArrayState = 5;
        ...
        private static class Proxy implements ICarService {
            ...
            public void putByteArraryState(String key, byte[] value) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_putByteArrayState, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_putStringState /*4*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_putByteArrayState /*5*/:
                    data.enforceInterface(DESCRIPTOR);
